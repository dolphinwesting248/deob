...
function writeReadingGuide(outputDir) {
...
module.exports = { analyzeStructure, generateMarkdown, generateIndex, generateCrossSummary, runStructure, writeReadingGuide, writeCrossReadme, applyTierFilter };
