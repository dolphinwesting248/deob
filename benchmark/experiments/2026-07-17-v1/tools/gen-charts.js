...
const scores = {
  A: { deob: 0.53, raw: 0.46 }, B: { deob: 0.40, raw: 0.31 },
  C: { deob: 0.82, raw: 0.77 }, D: { deob: 0.74, raw: 0.15 },
  E: { deob: 0.61, raw: 0.26 },
};
...
const radarData = {
  A: { deob: [0.17,0.38,1.00,0.31,0.60,1.00,1.00,0.13], raw: [0.58,0.46,0.33,0.17,0.50,1.00,1.00,0.13] },
  B: { deob: [0.56,0.39,1.00,0.00,0.52,0.00,1.00,0.08], raw: [0.44,0.16,1.00,0.00,0.39,0.00,1.00,0.08] },
  C: { deob: [0.60,0.78,1.00,1.00,0.45,1.00,1.00,0.06], raw: [0.60,0.62,1.00,1.00,0.48,1.00,1.00,0.06] },
  D: { deob: [0.88,0.82,1.00,0.38,0.58,1.00,1.00,0.15], raw: [0.00,0.17,0.00,0.16,0.34,0.00,1.00,0.15] },
  E: { deob: [0.85,0.37,1.00,0.40,0.58,1.00,1.00,0.12], raw: [0.62,0.29,0.00,0.18,0.50,0.00,1.00,0.12] },
};
const radarLabels = ["Purpose","Functions","Endpoints","Security","DataFlow","Vars","Entry","Token"];
