...
const scores = {
  A: { deob: 0.57, raw: 0.45 }, B: { deob: 0.41, raw: 0.32 },
  C: { deob: 0.83, raw: 0.77 }, D: { deob: 0.75, raw: 0.16 },
...
const radarData = {
  A: { deob: [0.17,0.38,1.00,0.31,0.60,1.00,0.73,1.00,0.56], raw: [0.58,0.46,0.33,0.17,0.50,1.00,0.27,1.00,0.44] },
  B: { deob: [0.56,0.39,1.00,0.00,0.52,0.00,0.63,1.00,0.43], raw: [0.44,0.16,1.00,0.00,0.39,0.00,0.37,1.00,0.57] },
  C: { deob: [0.60,0.78,1.00,1.00,0.45,1.00,0.70,1.00,0.39], raw: [0.60,0.62,1.00,1.00,0.48,1.00,0.30,1.00,0.61] },
  D: { deob: [0.88,0.82,1.00,0.38,0.58,1.00,0.78,1.00,0.59], raw: [0.00,0.17,0.00,0.16,0.34,0.00,0.22,1.00,0.41] },
  E: { deob: [0.85,0.37,1.00,0.40,0.58,1.00,0.57,1.00,0.54], raw: [0.62,0.29,0.00,0.18,0.50,0.00,0.43,1.00,0.46] },
};
