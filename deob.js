...
const CONFIG_TEMPLATE = `// deob configuration — generated by \`deob init\`
// See: deob --help
...
module.exports = {
  ...
  // When split is enabled, controls whether index.js glue files
  // are emitted alongside per-function files
  // emitIndex: true,
};
`;
